...
2. На каждой бирже доступно 5 валютных пар(это связанно с тем что мы можем подключиться к 5 патоком каждой биржи):
   - Binance - BTC-USDT, NOT-USDT, SOL-USDT, ETH-USDT, BNB-USDT.
   - ByBit   - BTC-USDT, NOT-USDT, KAS-USDT, ETH-USDT, SOL-USDT.
3. Статистика торговли:
   - За текущий день.
   - За текущию неделю.
   - За текущий месяц.
   - За текущие полгода.
...
8. Есть админка с правами Admin и SuperUser
...
4. Spring Boot Web - для отдачи сайта бота, где указанна подробная информация о нем.
5. XChange - Унифицированная библиотека для интеграции с различными криптовалютными биржами.
6. RxJava - Для подключение к webSoket биржи для получение данных в реальном времени.
7. Spring Boot Telegram - Интеграция с Telegram для создания ботов и взаимодействия с пользователями.
8. Lombok - Инструмент для сокращения шаблонного кода в Java и улучшения читабельности.
9. Jasypt - Библиотека для шифрования данных конфигурации и повышения безопасности.
10. RabbitMQ - Мессенджер для асинхронного обмена данными между сервисами.
11. MySQL - Надежная система управления базами данных для хранения и обработки данных.
12. PhpMyAdmin - Удобная веб-интерфейс для управления MySQL базами данных.
13. ~~Maven~~ Gradle - Средства сборки и управления зависимостями; переход на Gradle для более эффективной сборки.
14. Docker и Docker Compose - Контейнеризация и оркестрация приложений для упрощения развертывания и масштабирования.
15. JUnit и Mockito - Инструменты для написания и выполнения тестов, обеспечивающие высокое качество и надежность кода.
16. CI-CD GitHub actions. При вливании ветки в мастер запускаеться пай плайн.
17. Приложение развернуты на Ubunto 22.04
    
__Сайт бота(http://batrak.zapto.org/):__
1. HTML 
2. CSS
3. JavaScript(без фреймворка)
---
