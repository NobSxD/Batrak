package org.example.xchange.change.BayBit.config;
...
@Configuration
@ConfigurationProperties(prefix = "currency-baybit")
@Getter
@Setter
@RequiredArgsConstructor
public class CurrencyPropertiesBayBit {
	...
	public void saveNodeChange(){
		NodeChange nodeChange = nodeChangeDAO.findByChangeType(ChangeType.Baibit)
				.orElseGet(() -> NodeChange.builder()
						.changeType(ChangeType.Baibit)
						.build());
		// Удаление старых пар
