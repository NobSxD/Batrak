package org.example.xchange.change.Mex.config;
...
@Configuration
@ConfigurationProperties(prefix = "currency-mexc")
@Getter
@Setter
@RequiredArgsConstructor
public class CurrencyPropertiesMexc {
	...
	public void saveNodeChange(){
		NodeChange nodeChange = nodeChangeDAO.findByChangeType(ChangeType.Mex)
				.orElseGet(() -> NodeChange.builder()
						.changeType(ChangeType.Mex)
						.build());
		// Удаление старых пар
